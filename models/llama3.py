...
def load(model_id='alpindale/Llama-3.2-1B', tp_devices=1, hf_ckpt_dir='~/weights/huggingface'):
    ...
    tokenizer.pad_token_id = 0 # overwriting the default `None` for compatibility
